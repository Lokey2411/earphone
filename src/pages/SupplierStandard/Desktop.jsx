    ...
    <Box sx={{ ...styles.fontSize13 }}>
      ...
      <Layout.MainBg>
        ...
        >
          ...
          <Box sx={{ fontSize: "24px", lineHeight: "29px" }}>
        ...
        <Box sx={{ p: "80px 312px" }}>
          ...
          <Box sx={{ lineHeight: "33px", pb: "62px", fontSize: "24px" }}>
              ...
              .map((standard) => (
                <Accordion
                  sx={{
                    ...
                    "& .MuiButtonBase-root": { p: 0, gap: "50px" },
                  }}
                  disableGutters={true}
                >
                  <AccordionSummary
                    expandIcon={
                      <Box sx={{ ...styles.centerFlex }}>
                        ...
                        >
                          <path
                            d="M10 4.2779L1.97208 12.3054L0 10.3333L10 0.333313L20 10.3333L18.0279 12.3054L10 4.2779Z"
                            fill="#1C1B1F"
                          />
                        </svg>
                      </Box>
